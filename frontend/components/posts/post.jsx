  ...
  render() {
      ...
      ? (editForm = (
          <>
            <button
              ...
              className="delete_button hoverUp"
            >
      ...
      found
        ? // likes refreshing but not unlikes, even though it works, make found, likebool a function called on mount
          (likeBool = (
            <button
              onClick={() => {
                unlike(this.props.post.likes[0].id);
              }}
              className="like_button hoverUp"
            >
              <i
    ...
    if (!this.props.currentUser.profile_pic_url) {
      this.props.currentUser.profile_pic_url =
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGTjtPQ8LBaJLXxGwFuDi6jPWZQq3nszuKi8HHiRn0yT4xUGoPDw";
    }
