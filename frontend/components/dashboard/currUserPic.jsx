...
class currUserPic extends React.Component {
  ...
  render() {
    ...
    if (this.props.entities.users[this.props.session.id].profile_pic_url) {
      prof_pic = this.props.entities.users[this.props.session.id]
        .profile_pic_url;
    } else {
      prof_pic =
        "https://skinnyms.com/wp-content/uploads/2012/09/Slow-Cooker-Cheesy-Spaghetti-with-Homemade-Sausage-Recipe5-750x498.jpg";
    }
