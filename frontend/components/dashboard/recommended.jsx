        ...
        conditionalRendering = (
          <>
            <span className="recommended_person">
              <p className="align-right recommended_username">
                {users[0].username}
              </p>
              <img
                className="recommended_users_user_pic align-left"
            ...
            <span className="recommended_person">
              ...
              <img
                className="recommended_users_user_pic align-left"
                src={users[2].profile_pic_url}
                alt=""
              />
              <p className=" recommended_catchphrase">
                does dominos belong in nyc
              </p>
            </span>
            <hr />
    ...
    if (users) {
      radarPost = (
        <>
          ...
          <img
            className="recommended_users_user_pic align-left"
            src="https://i.ytimg.com/vi/WFMWGtqdGHI/maxresdefault.jpg"
            alt=""
          />
          <p className=" recommended_catchphrase">
          ...
          <br />
          <img
            className="radar_image"
            src="https://www.tasteofhome.com/wp-content/uploads/2017/10/Sweet-Chipotle-Pretzels_exps127818_TH1999636C03_28_6bC_RMS-2-696x696.jpg"
            alt=""
          />
        </>
      );
